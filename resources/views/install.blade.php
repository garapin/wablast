                ...
                <form class="ui grid form m-0" method="post" action="{{ route('settings.install_app') }}"
                    ...
                    <div class="ui fluid card">
                            ...
                            <div class="step admin" :class="{ active: stepIsActive(3) }">
                                <div class="field">
                                    ...
                                    <input type="text" required name="admin[username]"
                                        value="{{ old('admin.username', request()->input('admin.username','administrator')) }}">
                                </div>

                                <div class="field">
                                    <label>{{ __('Admin email') }}</label>
                                    <input type="email" required name="admin[email]"
                                        value="{{ old('admin.email', request()->input('admin.email','administrator@email.com')) }}">
                                </div>

                                <div class="field">
                                    <label>{{ __('Admin password') }}</label>
                                    <input type="text" required name="admin[password]"
                                        value="{{ old('admin.password', request()->input('admin.password','password')) }}">
                                </div>
                        ...
                        <div class="content footer ">
                            <button class="ui d-none  large previeus button ml-0 mr-auto" @click="navigateSteps(-2)"
                                type="button" :class="{ disabled: stepIsActive(1) }">{{ __('Previous') }}</button>
                            <button class="ui large next button ml-auto mr-0" @click="navigateSteps(2)"
